...
<?php include 'headtag.php'; ?>
  ...
  <body id="page-top">
    ...
    <?php 
      ...
      $query = "select * from transactions where transactionType = 'Withdrawal' AND transactionStatus = '0' "; 
    ...
    <div class="row" style="padding-top: 50px;padding-bottom: 50px;"> 
      <div class="col-sm-12">
        ...
        <table class="table table-striped" style="font-size: 8px;">
            <?php
      $query = "select * from transactions where transactionType = 'Withdrawal' AND transactionStatus = '0' order by dot desc, userId desc LIMIT :page1,10"; 
