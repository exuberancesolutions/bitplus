...
$responseData = json_encode(array(
							...
							'applicantFatherName' => $row['applicantFatherName'],
							'package' => $row['package']>0?$row['package']." USD":"-",
							'active' => $rowNew['active']==1?"active":"not active",
							'admin' => $rowNew['admin']==1?"admin":"member"
							),
							JSON_FORCE_OBJECT);
